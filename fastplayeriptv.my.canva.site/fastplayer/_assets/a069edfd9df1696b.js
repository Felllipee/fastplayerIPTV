            ...
            (function(__c) {
                ...
                var U4 = function(a, b) {
                    ...
                    J1b = function(a, b, c) {
                        switch (c.type) {
                            ...
                            case "canonical":
                                ...
                                return a.result !== "success" ? !1 : __c.SD(new __c.VD, a.iH).filter(d => {
                                    switch (d.type) {
                                        case 0:
                                            return U4(b, d);
                                        case 1:
                    ...
                    K1b = function(a, b, c, d) {
                        ...
                        for (const k of c)
                            for (const l of d) {
                                ...
                                if (!g || (k.boundary === "start" ? g.span.Qb === c : g.span.Sc === c))
                                    if (c = b.get(`${f.id}:${c.id}`), c = k.boundary === "start" ? c === null || c === void 0 ? void 0 : c.ra : c === null || c === void 0 ? void 0 : c.Fa) {
                                        ...
                                        h && (h = g.dXa, h = h.na === k.na && h.boundary === k.boundary);
                                        h && g.color === c.color && g.weight === c.weight && g.kc === c.kc && g.kc === 0 ? g.hpa = f : e.push({
                                            dXa: k,
                                            Dsb: l,
                                            hpa: f,
                                            color: c.color,
                            ...
                            for (const m of c) {
                                ...
                                if (!d || (l.boundary === "start" ? d.span.Mb === h : d.span.Gc === h))
                                    if (d = b.get(`${h.id}:${g.id}`), (d = l.boundary === "start" ? d === null ||
                                            d === void 0 ? void 0 : d.qa : d === null || d === void 0 ? void 0 : d.Ka) && (l.boundary !== "start" || e(g, h) !== 1)) {
                                        h = f[f.length - 1];
                                        ...
                                        var k;
                                        if (k = h) k = h.lIa, k = k.column === l.column && k.boundary === l.boundary;
                                        k && (k = h.lpa, k = k.na === m.na && k.boundary === m.boundary);
                                        k && h.color === d.color && h.weight === d.weight && h.kc === d.kc && h.kc === 0 ? h.lpa = g : f.push({
                                            lIa: l,
                                            Osb: m,
                                            lpa: g,
                                            color: d.color,
                    ...
                    M1b = function(a, b, c, d, e) {
                        const f =
                            a.XYa.H9a(c, b.layout.rows.last(), b.layout.cols.last());
                        a = (q, r) => {
                            const t = f.get(q) || 0,
                                v = f.get(r) || 0;
                            return t <= v ? q : r
                        ...
                        for (const q of h) {
                            ...
                            for (const r of e) {
                                ...
                                k = q.boundary === "end" ? l === null || l === void 0 ? void 0 : l.Ka : m === null || m === void 0 ? void 0 : m.qa;
                                m = r.boundary === "end" ? n === null || n === void 0 ? void 0 : n.Fa : m === null || m === void 0 ?
                                    void 0 : m.ra;
                                n = q.boundary === "end" ? p === null || p === void 0 ? void 0 : p.Ka : n === null || n === void 0 ? void 0 : n.qa;
                    ...
                    N1b = function(a, b, c, d, e, f) {
                        ...
                        a = g.map(n => {
                            ...
                            n = n.kc;
                            const y = m ? -1 : 1,
                                A = (p = h.get(V4(r, v))) === null || p === void 0 ?
                                void 0 : p.Ka;
                            p = (q = h.get(V4(t, v))) === null || q === void 0 ? void 0 : q.qa;
                            if (A != null && p != null) {
                                q = D(k.get(v.na));
                        ...
                        return [...f.map(n => {
                            ...
                            const u = n.color,
                                x = n.weight;
                            n = n.kc;
                            const y = (p = h.get(V4(r, t))) === null || p === void 0 ? void 0 : p.Fa;
                            p = (q = h.get(V4(r,
                    ...
                    P1b = function(a, b, c, d) {
                        ...
                        for (const k of b.get())
                            for (const l of c.get()) b = l && k ?
                                e.XYa.aqb(a, l, k) : void 0, b && h.set(`${l.id}:${k.id}`, b);
                        c = N1b(e, a, h, f, g, d);
                        return O1b(c)
                    },
                    W4 = function() {
                    ...
                    S1b = function(a) {
                        const b = a.direction === "rtl" ? -(0, __c.Vub)(a) / 2 : -(0, __c.Tub)(a) / 2,
                            c = -(0, __c.Uub)(a) / 2,
                    ...
                    V1b = function(a) {
                        ...
                        const e = a.context;
                        a = a.ep;
                        __c.C((d === null || d === void 0 ? void 0 : (b = d.cg) === null || b ===
                        ...
                        switch (b.type) {
                            ...
                            case 6:
                                var g;
                                d = (g = c.Vja) === null || g === void 0 ? void 0 : g.call(c, {
                                    content: __c.re(__c.F7a, { ...__c.$db,
                                        value: b.value
                                    }),
                                    context: e,
                                    ep: a
                    ...
                    U1b = function(a, b, c, d) {
                        var e;
                        return (e = a.Yja) === null || e === void 0 ? void 0 : e.call(a, {
                            context: b,
                            value: c,
                            valueType: d
                        })
                        ...
                        const a = new b2b,
                            ...
                            d = c5(f => {
                                const {
                                    ...
                                    size: k,
                                    Dta: h
                                }), [k, h]), q = h ? Math.max(g, h) : g, r = d5(u => m != null && a.Kxa(m).has(u), [m]), t = d5(u => m != null && a.Mfb(l, m).has(u), [l, m]), v = d5(u => {
                                    const x = n != null && l.layout.cols.Ie(u, n.Mb) >= 0 && l.layout.cols.Ie(u, n.Gc) <=
                                        0;
                            ...
                            e = c5(f => {
                                const {
                                    ...
                                    size: k,
                                    Dta: h
                                }), [k, h]), q = h ? Math.max(g, h) : g, r = d5(u => m != null && a.Mxa(m).has(u), [m]), t = d5(u => m != null && a.Nfb(l, m).has(u), [l, m]), v = d5(u => {
                                    const x = n != null && l.layout.rows.Ie(u, n.Qb) >= 0 && l.layout.rows.Ie(u, n.Sc) <= 0;
                                    return r(u) ?
                    ...
                    k2b = function(a) {
                        ...
                        class h extends i2b {
                            ...
                            constructor(...k) {
                                ...
                                this.Bh = c5(l => X4("div", {
                                    className: "wKvivQ",
                                    children: X4(__c.xLa, { ...this.props,
                                        ...l,
                                        ke: c
                                    })
                                }))
                    ...
                    l2b = function(a, b) {
                        if (b != null && b.Mb != null && b.Qb != null && b.Gc != null && b.Sc != null) {
                            var c = a.qa(b.Mb),
                                d = a.ra(b.Qb),
                    ...
                    r2b = function(a) {
                        const b = {
                            ...
                            d = k5(() => a.lz.style || c, h => {
                                ...
                                h = h === null || h === void 0 ? void 0 : (k = h.Ha) === null || k === void 0 ? void 0 : k.textDecoration;
                                a.kD.classList.toggle("OQx3PQ", h === "underline");
                                a.kD.classList.toggle("_99ezUA", h === "line-through");
                                a.kD.classList.toggle("kppAqQ", h === "underline line-through")
                            }, {
                                fireImmediately: !0,
                                equals: o2b
                            }),
                            ...
                            f = k5(() => a.renderer, h => {
                                a.x9 && (h === null || h === void 0 ? void 0 : h.type) !== "react" ? (a.x9 = void 0, a.G3.remove()) : a.pD.innerHTML = "";
                    ...
                    V4 = (a, b) => `${a.column.id}-${a.boundary}:${b.na.id}-${b.boundary}`,
                    W1b = ({
                        Cf: a,
                        BQ: b
                    }) => c => (0, __c.N)(__c.Yub, { ...c,
                        ...
                        return Z4("div", {
                            ...
                            children: [Z4("div", {
                                ...
                                children: [X4(a.Jp, { ...a,
                                    ...
                                    children: (c = a.pEa) === null || c === void 0 ? void 0 : (b = c.get()) === null || b === void 0 ? void 0 : b.map((g, h) => X4(g, {}, h))
                                })]
                            }), a.fGb === "visible" && Z4(u2b, {
                                children: [X4("div", {
                ...
                var X1b = (a, b) => __c.bLa((c, d) => {
                        ...
                        if (e.value.isEmpty)
                            ...
                            Ng: c
                        } = __c.tg(__c.ah, c.attrs)), c === "wrap" && (d = d.appendChild(document.createElement("div")), d.className = "dt4Dlg"), a.render({
                            container: d,
                            text: e.value,
                            nb: void 0,
                            writingMode: 1,
                    ...
                    constructor() {
                        ...
                        this.Mfb = r5((a, b) => {
                            ...
                            for (const e of c) {
                                ...
                                for (const f of R1b(c ? c.span.Mb : e.column, c ? c.span.Gc : e.column, a.layout.cols))(b.size === 0 || b.has(f)) && d.add(f)
                            }
                            return d
                        }, {
                            equals: __c.Jr
                        ...
                        this.Nfb = r5((a, b) => {
                            ...
                            for (const e of c) {
                                c = a.layout.cells.get(e.na, e.column);
                                for (const f of R1b(c ? c.span.Qb : e.na, c ? c.span.Sc : e.na, a.layout.rows))(b.size === 0 || b.has(f)) && d.add(f)
                            }
                            return d
                        }, {
                            equals: __c.Jr
                ...
                var K2b, L2b, M2b, N2b, O2b, P2b, Q2b = parseInt("4px", 10) || 4,
                    e5;
                new(K2b = class extends w5 {
                    ...
                    class a extends(N2b = o5) {
                        ...
                        get lq() {
                            var b;
                            const c = (b = this.props.Po) === null || b === void 0 ? void 0 : b.get();
                        ...
                        constructor(...b) {
                            super(...b);
                            this.onMouseMove = (e5.A(this), t5(c => {
                                const {
                                    onMouseMove: d,
                                    sheet: e,
                                    gd: f = 1
                            ...
                            this.AWa = (c, d, e) => {
                                const {
                                    ...
                                    jNbTIg: !this.ud,
                                    gtA7Dw: this.ud
                                }, p = (e === null || e === void 0 ? 0 : e.sticky) ? this.ud ? {
                                    right: 0
                                } : {
                                    left: 0
                                } : void 0;
                                var q;
                                const r = (e === null || e === void 0 ? 0 : e.sticky) ? (q = this.e5) !== null && q !== void 0 ? q : p : void 0;
                                let t = -1;
                                return Z4("div", {
                                    style: r,
                                    ...
                                    children: [f.layout.cols.map(v => {
                                        var u;
                                        t++;
                                        if (!(c && f.layout.cols.Ie(v, c) < 0 || d && f.layout.cols.Ie(v, d) > 0)) return X4(R2b, {
                                            col: v,
                                            label: __c.LA(t),
                                            Ta: k === null || k === void 0 ? void 0 : (u = k.get()) === null || u === void 0 ? void 0 : u.get(v),
                                            Qo: g,
                                            bE: h,
                                            gd: l,
                                            Ad: m
                                        }, v.id)
                                    }), (e === null || e === void 0 ? void 0 : e.sticky) && X4("div", {
                                        style: {
                                            width: Q2b * l
                                        },
                                        className: $4("HBvlug", "ru3tFQ",
                                            n)
                                    })]
                                })
                            };
                            this.M8a = c => {
                                ...
                                const e = this.props.sheet,
                                    f = e.view.freeze.VG ? e.layout.Nd.get(e.view.freeze.VG) : void 0,
                                    g = {
                                        jNbTIg: !this.ud,
                                        gtA7Dw: this.ud
                                    };
                ...
                new(L2b = class extends w5 {
                    ...
                    class a extends(P2b = o5) {
                        ...
                        constructor(...b) {
                            super(...b);
                            this.onMouseMove = (f5.A(this), t5(c => {
                                const {
                                    onMouseMove: d,
                                    sheet: e,
                                    Ad: f = 1
                            ...
                            this.GWa = (c, d, e) => {
                                ...
                                var p;
                                const q = (e === null || e === void 0 ? 0 : e.sticky) ? (p = this.e5) !== null && p !== void 0 ? p : n : void 0;
                                let r = -1;
                                return Z4("div", {
                                    style: q,
                                    ...
                                    children: [f.rows.map(t => {
                                        r++;
                                        if (!(c && f.rows.Ie(t, c) < 0 || d && f.rows.Ie(t, d) > 0)) return X4(S2b, {
                                            na: t,
                                            label: `${r+1}`,
                                            bE: h,
                                            Qo: g,
                            ...
                            this.rqb = c => {
                                var d;
                                const e = this.props.sheet,
                                    f = e.view.freeze.vV ? e.layout.$d.get(e.view.freeze.vV) : void 0,
                                    g = {
                                        jNbTIg: !this.ud,
                                        gtA7Dw: this.ud
                                    };
                ...
                var T2b = '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><circle stroke="currentColor" cx="6" cy="6" r="5.5"/></svg>';
                var U2b = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle stroke="currentColor" cx="12" cy="12" r="9.25" stroke-width="1.5"/></svg>';
                var $1b = __c.ER({
                    io: T2b,
                    medium: U2b
                });
                ...
                var y5 = parseInt("4px", 10) || 4,
                    Z2b = c5(({
                        ...
                        if (c != null && (d || e)) {
                            ...
                            if (d && e) return d = a.ra(c.Sc) + c.Sc.height, a = a.qa(c.Gc) + c.Gc.width, X4("div", {
                                style: {
                                    top: d * b,
                                    width: a * b,
                                    height: y5 * b
                            ...
                            if (d) return c = a.qa(c.Gc) + c.Gc.width, X4("div", {
                                style: {
                                    width: y5 * b,
                                    height: a.height * b,
                                    ...(f ? {
                                ...
                                className: $4("aX8dhQ", "gl1RPg",
                                    g)
                            });
                            if (e) return c = a.ra(c.Sc) + c.Sc.height, X4("div", {
                                style: {
                                    top: c * b,
                                    width: a.width * b,
                                    height: y5 * b
                ...
                var z5 = ({
                        ...
                        return X4("div", {
                            ref: e,
                            className: $4("nstn2A", a.direction === "rtl" ? "NgnL2Q" : "f8jAGQ"),
                            children: d
                        })
                    },
                    $2b = ({
                ...
                var j2b = c5(a => {
                    ...
                    h5(() => i5(() => {
                        var y = b.config.view.freeze.VG ? b.config.layout.Nd.get(b.config.view.freeze.VG) : void 0;
                        if (y != null)
                            if (b.config.qa(y) + y.width > x) {
                                if (y = r.VB.get(b)) y.style.overflowX =
                                    "hidden"
                ...
                var a3b = c5(({
                    ...
                    return X4("div", {
                        className: "Gi9pfA",
                        children: a.elements.map((e, f) => d == null ? c(e, f) : __c.xu(zu(e)).Uo(d) && c(e, f))
                    })
                });
                var b3b = new __c.qS,
                    A5 = a => __c.UV * a,
                    ...
                    d3b = c5(a => {
                        ...
                        h5(() => {
                            ...
                            return k5(() => y === null || y === void 0 ? void 0 : y.get(), A => {
                                const z = n.current;
                                if (A && z) {
                                    var B =
                        ...
                        const r = d5((y, A, z) => B5({
                            ...
                            t = b5(() => r ? () => r(l.sheet, !0, !1) : void 0, [r, l.sheet]),
                            v = b5(() => r ? () => r(l.sheet, !1, !0) : void 0, [r, l.sheet]);
                        var u;
                ...
                var s2b = class {
                    constructor(a) {
                                    ...
                                    if (k = e(c, g)) {
                                        ...
                                        if (!(g.width >
                                            ...
                                            for (g = d.indexOf(g) + 1; g < d.length; g++) {
                                                l = d[g];
                                                if (m = PH(b, c, l)) m = h, n = k, p = b.qa(l), m = m < p && p < n;
                                                if (m) f.set(l, 1);
                                                else break
                                            }
                                        }
                        ...
                        this.peb = (b, c, d) => {
                            ...
                            if (g && (g.ref.content.ref || g.ref.Aa.ref) && g.span.Qb === g.span.Sc && g.span.Mb === g.span.Gc) {
                                var h = this.aC.zv(b, c, d);
                                b = this.aC.mqa(b, c, d, __c.bh({
                                    Ng: void 0,
                                    textAlign: void 0
                                }));
                                var {
                                ...
                                if (k === "overflow") return __c.cLa(l, (e = g.ref.content.ref) === null || e === void 0 ? void 0 : e.type, (f = g.ref.Aa.ref) === null || f === void 0 ? void 0 : f.type, h ? () => h.hk.type : void 0)
                            }
                        }
                    }
                };
                ...
                var h3b, i3b, j3b, k3b, l3b, m3b, n3b, q2b = __c.Hw("285688d5", !1),
                    o3b, p3b = class extends o5 {
                        render() {
                            const {
                                Baa: a,
                                ...b
                            ...
                            return Z4("div", {
                                ref: this.$Ya,
                                className: $4("ZTz_iA", c.direction === "ltr" ? "TA4X7w" : "WvuqMw"),
                                children: [(a === null || a === void 0 ? void 0 : a.aHa) && X4(C5, { ...b,
                                    sheet: c,
                                    range: a.aHa.range,
                                    xv: !0,
                                    yv: !0,
                                    className: "_0C8M3w"
                                }), (a === null || a === void 0 ? void 0 : a.j2a) && X4(C5, { ...b,
                                    sheet: c,
                                    range: a.j2a.range,
                                    xv: !1,
                                    yv: !0,
                                    className: "_7n44yg"
                                }), (a === null || a === void 0 ? void 0 : a.DNa) && X4(C5, { ...b,
                                    sheet: c,
                                    range: a.DNa.range,
                                    xv: !0,
                                    yv: !1,
                                    className: "fF5r6w"
                                }), (a === null || a === void 0 ? void 0 : a.X0a) && X4(C5, { ...b,
                                    sheet: c,
                                    range: a.X0a.range,
                                    xv: !1,
                                    yv: !1,
                    ...
                    class a extends(l3b = o5) {
                        ...
                        get bounds() {
                            ...
                            return {
                                ...
                                Sc: (g = c === null || c === void 0 ? void 0 : c.Sc) !==
                        ...
                        constructor(...b) {
                            ...
                            this.JUa = mx();
                            this.XR = new q3b;
                            this.Jvb = j5(() => [...this.Zg.get().keys()].sort((c, d) => this.props.sheet.layout.rows.Ie(c, d)), {
                                equals: __c.Kr()
                            });
                            this.Hvb = j5(() => [...this.D6.get().keys()].sort((c, d) => this.props.sheet.layout.cols.Ie(c, d)), {
                                equals: __c.Kr()
                            });
                            this.Hja = c5(() => X4(this.props.Y4a, {
                                Zg: this.Jvb,
                                Ivb: this.Hvb,
                                deb: this.XR.meb,
                            ...
                            this.Zg = j5(() => {
                                ...
                                var e = this.props.Y,
                                    f = (c = this.vya) === null || c === void 0 ? void 0 : c.get();
                                ...
                                g = new Map;
                                for (let k = c.Qb; k != null && c.Sc != null && d.layout.rows.Ie(k, c.Sc) <= 0; k = d.layout.rows.next(k)) {
                                    const l = d.ra(k);
                                    if (!(l + k.height < h)) {
                                        if (l > f) break;
                                        g.set(k, l * e)
                            ...
                            this.D6 = j5(() => {
                                ...
                                g = new Map;
                                for (let k = c.Mb; k != null && c.Gc != null && d.layout.cols.Ie(k, c.Gc) <= 0; k = d.layout.cols.next(k)) {
                                    const l = d.qa(k);
                                    if (!(l + k.width < h)) {
                                        if (l > f) break;
                                        g.set(k, l * e)
                ...
                new(i3b = class extends w5 {
                    ...
                    class a extends(n3b = o5) {
                        ...
                        render() {
                            var b;
                            return Z4("div", {
                                ref: v2b(this.Fd, (b = this.lq) === null || b === void 0 ? void 0 : b.Yl),
                                children: [X4("div", {
                                    ref: this.vma,
                                    className: "_5YlOqQ"
                                }), X4("div", {
                        ...
                        componentDidMount() {
                            const b =
                                k5(() => [this.props.sheet, this.props.D6.get(), this.props.Zg.get()], ([e, f, g], h) => {
                                    [h] = h || [];
                                    e !== h && this.w8a();
                                    this.EGa(f, g)
                                }, {
                        ...
                        EGa(b, c) {
                            const d = D(this.vma.current),
                                ...
                                f = [],
                                g = new Map;
                            for (const h of this.SCa) c.has(h.na) ? g.set(h.na, h) : f.push(h);
                            for (const [h, k] of c) c = g.get(h) || f.pop(), c || (c = new r3b(this.G9, h), d.appendChild(c.L8), e.appendChild(c.N8), this.SCa.push(c)), c.update(k, h, b);
                        ...
                        G9(b, c) {
                            const d = this.props.lZ,
                                ...
                                g = this.props.XR;
                            b = new s3b(this.props.hN, this.props.zC, this.props.Bh, d(b, c), e, b, c, f, g.Qwa, this.Saa, this.Raa);
                            __c.Cc(this, r2b(b));
                            this.CK.push(b);
                            return b
                        }
                ...
                var r3b = class {
                        ...
                        update(a, b, c) {
                            ...
                            this.na = b;
                            for (const [d] of c) c = this.CK.get(d), c || (c = this.G9(d, b), this.CK.set(d, c), this.L8.appendChild(c.K8), this.N8.appendChild(c.pL)), c.update(b)
                        }
                        hide() {
                    ...
                    s3b = class {
                        ...
                        get Vqa() {
                            if (!q2b) return !1;
                            const a = this.Us;
                            return a == null || a.content.ref == null || a.content.ref.type !== "formula" ? !1 : this.hN(this.sheet, a.content.ref.value)
                        }
                        update(a) {
                            a !== this.na && (this.na = a, this.lz.na = a, this.soa && this.soa(), this.soa = this.Qwa(this.na, this.col, this))
                        }
                        get Aob() {
                            return this.x9
                        }
                        ...
                        get xsa() {
                            ...
                            const c = this.Saa("last"),
                                ...
                                e = this.Raa("last");
                            if (!(b && c && d && e)) return !1;
                            b = this.sheet.layout.rows.Ie(a.Qb, b) >= 0 && this.sheet.layout.rows.Ie(a.Qb, c) <=
                                0 ? a.Qb : b;
                            a = this.sheet.layout.cols.Ie(a.Mb, d) >= 0 && this.sheet.layout.cols.Ie(a.Mb, e) <= 0 ? a.Mb : d;
                        ...
                        get renderer() {
                            const a = this.Us;
                            if (a && this.xsa &&
                                (a.content.ref || a.Aa.ref)) return this.zC({
                                context: {
                                    container: this.jv,
                                    attrs: this.attrs
                                },
                        ...
                        get UIa() {
                            ...
                            if (a && (a = a.type === "react" ? this.G3 : this.pD, a.childNodes.length !== 0 && (a = a.childNodes[0], a instanceof HTMLElement))) return {
                                width: a.clientWidth,
                        ...
                        constructor(a, b, c, d, e, f, g, h, k, l, m) {
                            ...
                            this.Raa = m;
                            this.K8 =
                                (s3b.A(this), document.createElement("div"));
                            ...
                            this.kD.className = $4("pDMp7w", {
                                _0yZ6Qg: ((p = this.Us) === null || p === void 0 ? void 0 : (n = p.content.ref) === null || n === void 0 ? void 0 : n.type) !== "text3",
                                qhF5uA: ((r = this.Us) === null ||
                                    r === void 0 ? void 0 : (q = r.content.ref) === null || q === void 0 ? void 0 : q.type) !== "text3" && ((v = this.Us) === null || v === void 0 ? void 0 : (t = v.content.ref) === null || t === void 0 ? void 0 : t.type) !== "text2",
                                qxD1GA: this.Vqa
                            });
                ...
                new(t3b = class extends w5 {
                    ...
                    class a extends(v3b = o5) {
                        ...
                        render() {
                            ...
                            if (!c.layout.cols.empty && !c.layout.rows.empty) return X4("div", {
                                className: $4("SNkrHw", c.direction === "ltr" ? "TA4X7w" : "WvuqMw", {
                                    RaA0Nw: n
                                }),
                                ...h,
                                children: X4(o3b, {
                        ...
                        get Baa() {
                            ...
                            const c = {},
                                d = b.view.freeze.vV ? b.layout.$d.get(b.view.freeze.vV) : void 0,
                                e = b.view.freeze.VG ? b.layout.Nd.get(b.view.freeze.VG) : void 0,
                        ...
                        constructor(...b) {
                            ...
                            this.lZ = (c, d) => new __c.vLa(this.props.aC, this.props.ez, this.props.sheet, c, d, this.Y, this.Dt, this.Ht);
                            this.Dt = (c, d) => {
                                var e, f;
                                return (e = (f = this.props).Dt) === null || e === void 0 ? void 0 : e.call(f, this.props.sheet, c, d)
                            };
                            this.Ht = (c, d) => {
                                var e, f;
                                return (e = (f = this.props).Ht) === null ||
