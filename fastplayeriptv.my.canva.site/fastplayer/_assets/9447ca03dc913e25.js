            ...
            (function(__c) {
                ...
                var C3b = function(a, b, c, d) {
                    ...
                    G5 = function(a) {
                        var b;
                        const c = { ...__c.Bv,
                            Ia: (b = a === null || a === void 0 ? void 0 : a.Ia) !== null && b !== void 0 ? b : 0
                        };
                    ...
                    P3b = function(a, b) {
                        ...
                        K3b(a.cells, c, (e, f) => {
                            ...
                            g || (K5(e.fill, f.fill), M3b(e.border, f.border), N3b(e.X, f.X))
                        }, e => J5(e));
                        O3b(a.behavior, b, c);
                        K5(a.fill, b.fill);
                        N3b(a.X, b.X);
                    ...
                    O3b = function(a, b, c) {
                        L5(a.rules, [b], d => {
                            ...
                            Q3b(d.grid.gridTemplateRows, b.gridTemplateRows) || (d.grid.gridTemplateRows = b.gridTemplateRows);
                            var e;
                            ...
                            K3b(d.grid.dh, c, (g, h) => {
                                ...
                                g.gridRowEnd =
                                    n;
                                typeof k === "number" && g.padding.all !== k ? g.padding.all = k : typeof k !== "number" && (g.padding.ra = k === null || k === void 0 ? void 0 : k.ra, g.padding.Fa = k === null || k === void 0 ? void 0 : k.Fa, g.padding.qa = k === null || k === void 0 ? void 0 : k.qa, g.padding.Ka = k === null || k === void 0 ? void 0 : k.Ka);
                                g.alignSelf = p
                            }, g => I3b(g))
                        }, d => {
                            var e, f;
                    ...
                    R3b = function(a, b) {
                        L5(a.lb, b.lb, (e, f) => {
                            e.d = f.d;
                            K5(e.fill, f.fill);
                            e.stroke.ref && f.stroke ? (e = e.stroke.ref, f = f.stroke, e.color = f.color, e.weight = f.weight) : e.stroke.set(J3b(f.stroke))
                        }, e => D3b(e));
                        const {
                            viewBox: c,
                            width: d
                    ...
                    L3b = function(a, b, c) {
                        switch (b.type) {
                            case "shape":
                                ...
                                break;
                            case "text":
                                a.type === "text" && __c.Dk.domain.Nb(__c.Dk.ka(a.text), F3b(b).text) || c();
                                break;
                            case "layout":
                    ...
                    M3b = function(a, b) {
                        b = H5(b).all;
                        var c;
                        if (c = b) c = a.all.ref, c = !(c && b ? __c.cE.domain.Nb(__c.cE.ka(c), b) : !c && !b);
                        c && a.all.set(b)
                    },
                    Q3b = function(a, b) {
                    ...
                    V3b = function(a, b, c, d, e) {
                        ...
                        const h = e.vx,
                            ...
                            m = e.kSa;
                        c = __c.RP.ka(c);
                        const n = ((f = (g = a.Gz).Jqa) === null || f === void 0 ? void 0 : f.call(g, d)) || __c.OV;
                        h.Ej === k && U3b.structural(c, l) && n.mode === m || (e.xGa = c, e.lQa = h.Ej, e.kSa = n.mode, b = b.render(h, n), a.Skb.update(d, b), C3b(d, b, (p, q) => a.XP.Sra.set(p, q), (p, q, r) => a.XP.refs.set(p, {
                            ref: q,
                            key: r
                        })))
                    },
                    ...
                    Z3b = function(a, b) {
                        return {
                            vD: ({
                                ...
                                const {
                                    vx: e
                                } = T3b(a.renderer, c, b, a.Y1), f = __c.TP.create([]), g = [];
                                g.push(Y3b(a.ndb, f));
                                g.push(W3b(() => {
                                    var k, l;
                                    return [(k = (l = a.Gz).Jqa) === null || k === void 0 ? void 0 : k.call(l, f), __c.RP.ka(c),
                                        e.Ej
                                    ]
                                }, () => {
                ...
                var c4b = class {
                    ...
                    S3b = class {
                        ...
                        Xl(a) {
                            this.mQa.set(a instanceof Function ? { ...this.Ej,
                                ...a()
                            } : { ...this.Ej,
                                ...a
                            })
                ...
                var d4b = class {
                    constructor(a) {
                        ...
                        this.update = (b, c) => {
                            ...
                            for (const d of b) C(d.type === "layout"), d.width = c.minWidth, d.height = c.minHeight, d.J = c.minWidth, d.W = c.minHeight, c.direction && (d.direction = c.direction), this.xk.yfa(d)
                        }
                    }
                };
                var e4b = class {
                ...
                var f4b = class {
                        ...
                        constructor(a, b) {
                            ...
                            this.Spa = new Set;
                            this.Flb = () => {
                                this.raa || (this.raa = __c.Xga(this.Xb).subscribe(d => {
                                    a4b(() => {
                                        this.Msa.add(d.id)
                                    })
                                }));
                                ...
                                return () => {
                                    this.Spa.delete(c);
                                    this.Spa.size <= 0 && this.raa && (this.raa.unsubscribe(), this.raa = void 0)
                                }
                            }
                        }
                    },
                    X3b = class extends __c.AC {
                        ...
                        eQ(a) {
                            this.Hpa = (a = a.text.Ox("font-family")["font-family"].values().next().value) &&
                                __c.Xr(a).id
                        }
                    };
                var g4b = !1,
                    h4b = class {
                        register(a, b) {
                            this.oD.has(a) || (this.oD.set(a, b), g4b || (__c.SP.set(a, Z3b(this, b)), g4b = !0))
                        }
                        get(a) {
