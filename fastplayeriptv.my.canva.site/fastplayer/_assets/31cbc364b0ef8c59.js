            ...
            (function(__c) {
                ...
                var s5b = function(a) {
                        ...
                        switch (typeof a) {
                            ...
                            case "object":
                                ...
                                switch (a.kind) {
                                    ...
                                    case "set":
                                        var c;
                                        if (c = b.kind === "set") a = a.items, b = b.items, c = a === b ? !0 : a.size !== b.size ? !1 : b6([...a], [...b]);
                                        return c;
                                    case "map":
                                        if (c = b.kind === "map") a = a.items, b = b.items, c = a === b ? !0 : a.size !== b.size ? !1 : b6([...a.keys(), ...a.values()], [...b.keys(),
                                            ...b.values()
                                        ]);
                                        return c;
                                    case "record":
                    ...
                    e6 = function(a, b, c) {
                        switch (c.kind) {
                            ...
                            case 3:
                                const h = c.args.map(v => v.kind !== 13 ? new H5b(e6(a, b, v)) : new I5b(e6(a, b, v.bHb)));
                                c = c.name;
                                switch (c) {
                                    case 0:
                                    case 1:
                                        var d = h.map(v => v.Kpa(u => u.type, u => u.type.pN()));
                                        return g6.union(...d).map(J5b[c]).map(v => K5b(v, h));
                                    default:
                            ...
                            case 5:
                                ...
                                if (!$5(c, g6.primitive)) throw Error(`key type is not a primitive: ${c}`);
                            ...
                            case 9:
                                return S5b(b, c.name);
                            case 10:
                                return d = __c.ud(c.defs, v => e6(a, b, v)), T5b(a, b, d, c.body);
                            case 11:
                    ...
                    K5b = function({
                        ...
                        let e;
                        const f = d.map(g => g.Ila(h => h.as(a), h => h.as(e !== null && e !== void 0 ? e : e = g6.j9(a))));
                        return new j6(b, g => {
                            const h = l => l(g),
                                k = f.map(l => l.Ila(h, h));
                            return () => {
                    ...
                    M5b = function(a, b, c, d) {
                        return d(a.define(b, c)).map((e, f) => new $5b(c, e, g => h => f(g.define(b, h))))
                    },
                    W5b = function(a) {
                        let b;
                        return c => {
                    ...
                    e6b = function(a) {
                        ...
                        class d {
                            ...
                            s6(H) {
                                return H ? new d(this.type, this.Iha, (I, K, M) => {
                                    M = this.vfa(I, K, M);
                                    M != null && H(I, K, M);
                                    return M
                                }, (I, K, M, Q) => {
                        ...
                        a = new d(b.string, H => H, m6("string", H => H.value), n6("string"));
                        const e = new d(b.Yh, H => H, m6("boolean", H => H.value), n6("boolean")),
                            f = (new d(b.number, H => H, m6("int32", H => H.value), n6("int32"))).s6(H => Number.isInteger(H)),
                            g = (new d(b.number, H => H, m6("double", H => H.value), n6("double"))).s6(H => Number.isFinite(H)),
                            h = new d(b.instance("Fill"),
                                H => c.instance("Fill", H), m6("fill", H => H.value), n6("fill")),
                            k = a.optional(),
                            l = e.optional(),
                            m = f.optional(),
                            n = g.optional(),
                    ...
                    g6b = function() {
                        return (new f6b({})).add((a, b) => ({
                            Fill: new a("Fill", {
                                color: b.string
                            }, c => __c.OO.create({ ...__c.Bv,
                                color: c.color
                            }))
                        })).add((a, b) => ({
                            RectElement: new a("RectElement", {
                                ...
                                var d, e, f;
                                const g = __c.zv.create({ ...__c.Av,
                                    top: c.top,
                                    left: c.left,
                                    width: c.width,
                                    height: c.height,
                                    rotation: (e = c.rotation) !== null && e !== void 0 ? e : __c.Av.rotation,
                                    fill: __c.Bv,
                                    X: (f = (d = c.X) === null || d === void 0 ? void 0 : d.items) !== null && f !== void 0 ? f : __c.Av.X
                                });
                    ...
                    i6b = function(a, b) {
                        return class extends h6b {
                            ...
                            render() {
                                return this.state.hasError ? p6(__c.oy, {
                        ...
                        switch (c.type) {
                            case 0:
                                ...
                                if (typeof c === "object") {
                                    ...
                                    return j6b(a, d, b, e, c, f => new k6b(() => f().map(g => g.instance)))
                                }
                                return l6b(d, b, c);
                            case 1:
                    ...
                    l6b = function(a, b, c) {
                        return {
                            type: 0,
                            vD: d => c(b.apply(a(d)).data)
                        }
                    },
                    m6b = function(a, b, c, d) {
                        return {
                            type: 1,
                            Component: i6b(a.H, o6b(({
                                model: e
                            }) => {
                ...
                var a6 = class {
                    ...
                    u6 = class extends a6 {
                        ...
                        Sta(a) {
                            var b;
                            const c = (b = this.propTypes) !== null && b !== void 0 ? b : this.propTypes = this.Nca();
                    ...
                    B6b = class extends u6 {
                        $0(a) {
                            return a instanceof B6b && $5(this.key, a.key) && $5(this.value, a.value)
                        }
                        toString() {
                    ...
                    C6b = class extends u6 {
                        $0(a) {
                            return a instanceof
                            C6b ? Object.entries(a.fields).every(([b, c]) => this.fields.hasOwnProperty(b) && $5(this.fields[b], c)) : !1
                        }
                        Nca() {
                            return this.fields
                        }
                    ...
                    y6 = class extends a6 {
                        ...
                        Iya(a) {
                            return this.sm.some(b =>
                                b.Iya(a))
                        }
                        toString() {
                            return this.sm.length ? this.sm.map(a => a.toString()).join(" | ") : "never"
                        }
                        constructor(a) {
                            super();
                            this.sm = a;
                ...
                var L6b, M6b, A6 = Symbol("value"),
                    B6 = class {
                        get props() {
                            var a;
                            return (a = this.M5a) !== null && a !== void 0 ? a : this.M5a = this.kla()
                        }
                    },
                    N6b = class {
                        get size() {
                ...
                var O6b = class extends B6 {
                        ...
                        toString() {
                            return this.items.length ? `[${Array.from(this.items,d6).join(", ")}]` : "[]"
                        }
                        constructor(a) {
                            super();
                            this.kind = "array";
                ...
                var Q6b = class extends B6 {
                        ...
                        toString() {
                            return this.items.size ? `Set [${Array.from(this.items,d6).join(", ")}]` : "Set []"
                        }
                        constructor(a) {
                            super();
                            this.kind = "set";
                    ...
                    R6b = class {
                        toString() {
                            return this.items.size ? `Map {${Array.from(this.items,([a,b])=>`[${d6(a)}]: ${d6(b)}`).join(", ")}}` : "Map {}"
                        }
                        constructor(a) {
                            this.items = a;
                            this.kind = "map"
                    ...
                    S6b = class extends B6 {
                        ...
                        toString() {
                            ...
                            return a.length ? `{ ${[...a].map(([b,c])=>`${b}: ${d6(c)}`).join(", ")} }` : "{}"
                        }
                        constructor(a) {
                            super();
                            this.fields = a;
                ...
                var E5b = {
                    ...
                    L5b = {
                        [2]: new t6(g6.number, g6.number, a => a.reduce((b, c) => b + c, 0)),
                        [3]: new t6(g6.number, g6.number, a => a.reduce((b, c) => b * c, 1)),
                    ...
                    u6b = a => l6.map(a),
                    z5b = {
                        [0]: (a, b) => new v6b(a, b, g6.map(a, b))
                    },
                    w6b = a => l6.Wc(a),
                    P5b = {
                        [0]: a => new x6b(a, g6.Wc(a))
                    },
                    ...
                    B5b = {
                        ...
                        [1]: (a, b) => b.pN().map(c => Z5(a, g6.array(c), g6.array(c), $6b)),
                ...
                var f7b = (a, b, c) => {
                    ...
                    $5b = class {
                        as(a, b) {
                            if (!$5(a, this.jla)) throw Error(`argument type ${a} is not assignable to parameter type: ${this.jla}`);
                            if (!$5(this.resultType, b)) throw Error(`return type ${this.resultType} is not assignable to expected type: ${b}`);
                            return this.evaluate
                        }
                        map(a) {
                ...
                var f6b = class {
                    ...
                    g7b = class {
                        constructor(a, b, c) {
                            this.name = a;
                            this.create = c;
                            this.hlb = new i6(g6.Wc(b), g6.instance(this), d => l6.instance(this, c(d.fields)))
                        }
                    };
                var b6b = class {
                    error(a, b) {
                        return Error(`widget '${this.Xvb}': schema error on key '${a}': ${b}`)
                    }
                    constructor(a) {
                        this.Xvb = a
                    }
                ...
                var j7b = new Set,
                    ...
                    l7b = class {
                        ...
                        Rcb(a) {
                            var b;
                            return (b = this.Lfa.get(a)) === null || b === void 0 ? void 0 : b.element
                        }
