        ...
        82986: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                m4b = function({
                    ...
                    if (!b) throw Error(`Variant ${a.TP} not found for blueprint ${a.Kla}`);
                    return {
                        Na: b.Na
                    }
                };
                ...
                v4b = async function(a, b) {
                    ...
                    if (e) {
                        ...
                        var f = setInterval(() => a.t2.yY.send({
                            type: "ack",
                            requestId: c
                        }), 9E3);
                        try {
                            ...
                            if (k instanceof S5) {
                                var h = k;
                                k.code === "internal_error" ? a.H.Db(k, {
                    ...
                    } else h = u4b(a.t2, c, "internal_error", `No request handler configured for path: "${d}".`),
                        h.ok || a.H.PL(h.error, {
                            qe: "unable to send error response",
                            tags: new Map([
                                ["type", "request"],
                ...
                A4b = async function(a, b, c, {
                    ...
                    c = ({
                        ...
                        var n;
                        (k === null || k === void 0 ? 0 : (n = k.source) === null || n === void 0 ? 0 : n.startsWith("react-")) || (m !== g.ECa ? z4b(m) || b.info("received message event from an unexpected origin", {
                            extra: new Map([
                                ["expected", g.ECa],
                                ["actual", m]
                            ])
                            ...
                            source: "parent"
                        }, g.PXa, [a]), f.resolve(void 0)) : b.HK(l.error, {
                            extra: new Map([
                                ["data.source", k === null || k === void 0 ? void 0 : k.source]
                            ])
                        })))
                        ...
                        const c = this.XUa,
                            ...
                            f = async function() {
                                ...
                                try {
                                    ...
                                    return g instanceof T4b ? Ha(new S5({
                                        code: "internal_error",
                ...
                var V4b = class {
                    handle(a, b) {
                        if (this.requestHandler.has(a)) throw new S5({
                            code: "internal_error",
                ...
                var B4b = "canva-dev.com canva-dev.cn canva-staging.com canva-staging.cn canva.com canva.cn canva-apps.com canva-apps.cn canva-apps-dev.com canva-apps-dev.cn canva-apps-staging.com canva-apps-staging.cn".split(" ");
                var C4b = class {
                    async wB(a, b) {
                        const {
                            port1: c,
                ...
                __c.ZQa = {
                    Wgb: function(a) {
                        ...
                        return {
                            ...
                            CBb: a.rbb ? Promise.all([__webpack_require__.me(697956).then(() => __c.b5b), __webpack_require__.me(411625).then(() => __c.c5b), __webpack_require__.me(305660).then(() => __c.d5b), __webpack_require__.me(696820).then(() => __c.e5b)]).then(([e, f, g, h]) => ({
                                yBb: b("w:cm9wgGptP", e),
                                zBb: b("w:yLMS4dWnl", f),
                                ABb: b("w:2flp30CGQ", g),
                                BBb: b("w:1Nv6K6Dtv", h)
